"""
Strategy 015 — Regime-conditioned RF buy classifier on EURUSD 5m.
Variant of 014 with 1:3 risk:reward (TP = 60 pips, SL = 20 pips).
...
TP = +60 pips, SL = -20 pips, max hold = 200 bars. Spread (1 pip) is
