"""
Strategy 017 — Regime-conditioned RF buy classifier on EURUSD 1h.
1h version of strategy 014 (TP = 5 pips, SL = 20 pips).
...
Pipeline:
  ...
  4. Per-bar binary label: 1 if High >= entry + TP before Low <= entry - SL
     within 200 forward bars (SL priority on same-bar tie).
        TP = 5 pips, SL = 20 pips, 1-pip spread deducted at exit.
...
TP = +5 pips, SL = -20 pips, max hold = 200 bars (~8.3 days on 1h).
