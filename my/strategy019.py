"""
Strategy 019 — Regime-conditioned RF buy classifier on EURUSD 1h.
1h version of strategy 016 (1:5 R:R, TP = 100 pips, SL = 20 pips).
...
TP = +100 pips, SL = -20 pips, max hold = 200 bars (~8.3 days on 1h).
